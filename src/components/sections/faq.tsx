  ...
  },
  {
    ...
    data: [
      ...
      },
      {
        ...
        answer:
          "Each team must consist of a minimum of 2 and a maximum of 4 participants. Solo participation is not allowed.",
      },
      {
        question: "Can team members be from different colleges?",
        answer:
          "Yes. Teams may consist of participants from different colleges or universities.",
      },
    ],
  },
  {
    ...
    data: [
      ...
      },
      {
        ...
        answer:
          "Participants should bring their laptops, chargers, and any required hardware. Internet access and workspace will be provided.",
      },
    ],
  },
  {
