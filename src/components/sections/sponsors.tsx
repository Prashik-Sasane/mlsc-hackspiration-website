                ...
                >
                    <div className="relative group max-w-2xl w-full">
                        ...
                        <div className="relative bg-zinc-900/80 border-2 border-neon-cyan/40 rounded-2xl p-12 hover:border-neon-cyan transition-all duration-500 backdrop-blur-xl">
                            ...
                            {/* Algorand Logo/Text */}
                            <div className="text-center mb-8">
                                <h3 className="text-4xl sm:text-6xl md:text-8xl font-black text-transparent bg-gradient-to-r from-neon-cyan to-neon-magenta bg-clip-text mb-4 font-mono tracking-normal break-words">
                                    ALGORAND
                                </h3>
